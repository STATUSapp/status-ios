...
{
    [super viewDidLoad];
    self.backgroundBlurImgView.image = _bluredImage;
    _imageView = [[UIImageView alloc] initWithImage:_fullImage];
    _imageView.frame = (CGRect){.origin=CGPointMake(0.0f, 0.0f), .size=_fullImage.size};
